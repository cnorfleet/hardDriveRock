/*
   ...
   uPs Final Project
   Based on uPs Lab 6 starter code
...
const char* networkName = "Lab6_ESP_02"; // Set this to the selected network SSID
  ...
  while (true) {
    ...
    if ((webpage.indexOf("</html>") != -1) || (millis() > lastByteTime + 200)) {
      if (webpage.length() < 10) {
        webpage = "Could not connect to SAM4S. Please check your connections. (10 or fewer bytes were recieved from the processor.)";
      }
